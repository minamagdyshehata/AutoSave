...
## All Settings are adjustable through arguments (use -h pr --help to check them)
## This the registery path used for the script to autorun when your machine boots:
...
##    in 5 seconds maximuze you program and it will be added or removed automatically
